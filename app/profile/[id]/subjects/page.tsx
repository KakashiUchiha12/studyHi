...
export default function UserSubjectsPage() {
        ...
        <div className="container max-w-4xl py-6 px-4 md:py-10">
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">{profile.name}'s Subjects</h1>
                        <p className="text-muted-foreground text-sm">Viewing all subjects</p>
                    </div>
                </div>
